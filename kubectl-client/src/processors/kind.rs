...
impl ProcessorKind {
    ...
    pub fn process(
        ...
        use ProcessorKind::*;
        match self {
            ClusterRoleBinding => run(
                &ClusterRoleBindingProcessor,
                lua,
                items,
                sort_by,
                sort_order,
            ...
            CustomResourceDefinition => run(
                &ClusterResourceDefinitionProcessor,
                lua,
                items,
                sort_by,
                sort_order,
            ...
            HorizontalPodAutoscaler => run(
                &HorizontalPodAutoscalerProcessor,
                lua,
                items,
                sort_by,
                sort_order,
            ...
            PersistentVolume => run(
                &PersistentVolumeProcessor,
                lua,
                items,
                sort_by,
                sort_order,
            ...
            PersistentVolumeClaim => run(
                &PersistentVolumeClaimProcessor,
                lua,
                items,
                sort_by,
                sort_order,
