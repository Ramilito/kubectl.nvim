...
function M.Hints(headers)
  ...
  local globals = {
    ...
    { key = s(gl.filter.key), desc = "Filter on a phrase" },
    { key = s(gl.namespaces.key), desc = "Change namespace" },
    { key = s(gl.go_up.key), desc = "Go up a level" },
    { key = s(gl.delete.key), desc = "Delete resource" },
    { key = s(gl.view_pf.key), desc = "Port forwards" },
    { key = s(gl.sort.key), desc = "Sort column" },
    { key = s(gl.edit.key), desc = "Edit resource" },
    { key = s(gl.reload.key), desc = "Reload view" },
