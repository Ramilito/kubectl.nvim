...
function M.Hints(headers)
  ...
  local globals = {
    ...
    { key = "<Plug>(kubectl.toggle_hints)", desc = "Toggle hints" },
    { key = "<Plug>(kubectl.toggle_context)", desc = "Toggle context" },
    { key = "<Plug>(kubectl.toggle_versions)", desc = "Toggle versions" },
    { key = "<Plug>(kubectl.toggle_heartbeat)", desc = "Toggle heartbeat" },
