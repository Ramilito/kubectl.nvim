local pvc_definiton = require("kubectl.resources.persistentvolumeclaims.definition")
local pvc_view = require("kubectl.resources.persistentvolumeclaims")
...
M.overrides = {
  ["<Plug>(kubectl.select)"] = {
    ...
    desc = "Go to PVs",
    callback = function()
      local pv_view = require("kubectl.resources.persistentvolumes")
